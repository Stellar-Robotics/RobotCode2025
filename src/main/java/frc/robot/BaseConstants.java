...
public final class BaseConstants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxAngularSpeedFactor = 1; //4.8
  ...
  public static final class PathPlannerConstants {
    ...
    public static final double massKG = 150;
    public static final double momentOfInertia = 6.8;
    public static final int numMotors = 1; // Means holonomic
    public static final DCMotor motorType = DCMotor.getNEO(numMotors);
    public static final double gearing = 5;
    public static final ModuleConfig moduleConfig = new ModuleConfig(
      0.048, 
      5.450, 
      1.2, 
      motorType.withReduction(gearing), 
      50, 
      numMotors
    );
    public static final double trackWidth = 1.5;
    public static final double wheelBase = 1.5;
  }
}
