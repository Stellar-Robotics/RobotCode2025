...
public class VisionConstants {
    ...
    public static final class PositionConstants {
        ...
        public static final Transform3d reefCamTransform = new Transform3d(new Translation3d(0.346, -0.116, 0.243), new Rotation3d(Math.toRadians(2), Math.toRadians(357), Math.toRadians(358)));
        ...
        public static final AprilTagFieldLayout tagPositions = AprilTagFieldLayout.loadField(AprilTagFields.k2025ReefscapeAndyMark);
